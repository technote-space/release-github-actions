...
- minor tag name (generated by tag name)
  - e.g. `v1.2`
### Re-run
If you want to re-run this action, please save as draft and publish it again.  
1. Save draft  
   ![Save draft](https://raw.githubusercontent.com/technote-space/release-github-actions/images/screenshot-5.png)
1. Publish release  
   ![Publish release](https://raw.githubusercontent.com/technote-space/release-github-actions/images/screenshot-6.png)
