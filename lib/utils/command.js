...
const cloneForBuild = (context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield exports.execAsync({ command: `git -C ${buildDir} fetch --depth=${depth} ${url} ${context.ref}`, quiet: true, altCommand: `git fetch origin ${context.ref}` });
    yield exports.execAsync({ command: `git -C ${buildDir} checkout -qf ${checkout}` });
});
