...
const output = (type, message, ...args) => {
    signale[type](exports.replaceDirectory(message), ...args);
};
// eslint-disable-next-line @typescript-eslint/no-explicit-any
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const displayStdout = (message, ...args) => output('command', `   >> ${message}`, ...args);
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const displayStderr = (message, ...args) => output('warn', `   >> ${message}`, ...args);
// eslint-disable-next-line @typescript-eslint/no-explicit-any
