...
exports.isTargetEventName = (events, context) => context.eventName in events;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
exports.isTargetEventAction = (action, context) => {
    if (Array.isArray(action)) {
        return action.some(item => exports.isTargetEventAction(item, context));
    }
...
exports.isTargetEvent = (context) => exports.isTargetEventName(constant_1.TARGET_EVENTS, context) && exports.isTargetEventAction(constant_1.TARGET_EVENTS[context.eventName], context);
...
exports.getGitHubToken = () => core_1.getInput('GITHUB_TOKEN', { required: true });
exports.getGitUrl = (context) => {
    const token = exports.getGitHubToken();
...
exports.isValidTagName = (tagName) => exports.isSemanticVersioningTagName(tagName) || (exports.isTestTag(tagName) && exports.isSemanticVersioningTagName(exports.getTestTag(tagName)));
