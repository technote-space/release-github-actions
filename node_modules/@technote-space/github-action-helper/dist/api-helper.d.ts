...
import { Response, GitCreateTreeResponse, GitCreateCommitResponse, PullsListResponseItem, PullsCreateResponse, PullsUpdateResponse } from '@octokit/rest';
...
export default class ApiHelper {
     ...
     */
    pullsList(params: PullsListParams, octokit: GitHub, context: Context): AsyncIterable<PullsListResponseItem>;
    /**
     * @param {string} branchName branch name
     ...
     */
    pullsCreateOrUpdate: (createBranchName: string, detail: PullsCreateParams, octokit: GitHub, context: Context) => Promise<PullsInfo>;
    /**
