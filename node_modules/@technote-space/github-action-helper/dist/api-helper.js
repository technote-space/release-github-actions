    ...
    constructor(logger) {
        ...
        this.updateRef = (commit, octokit, context) => __awaiter(this, void 0, void 0, function* () {
            yield octokit.git.updateRef({
                owner: context.repo.owner,
                repo: context.repo.repo,
                ref: utils_1.getRefForUpdate(context),
                sha: commit.data.sha,
            });
        });
        /**
         ...
         */
        this.checkProtected = (octokit, context) => __awaiter(this, void 0, void 0, function* () {
            const branch = utils_1.getBranch(context);
            try {
        ...
        this.commit = (rootDir, commitMessage, files, octokit, context) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield this.checkProtected(octokit, context)) {
                this.logger.warn('Branch [%s] is protected', utils_1.getBranch(context));
                return false;
            }
            this.logger.startProcess('Start push to branch [%s]', utils_1.getBranch(context));
            ...
            this.logger.startProcess('Updating ref [%s] [%s]', utils_1.getRefForUpdate(context), commit.data.sha);
        ...
        this.getUser = (octokit, context) => __awaiter(this, void 0, void 0, function* () {
            const sender = utils_1.getSender(context);
            if (false === sender) {
