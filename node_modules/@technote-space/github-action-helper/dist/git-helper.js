...
class GitHelper {
    ...
    constructor(logger, options) {
        ...
        this.getTags = (workDir, options) => __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield this.runCommand(workDir, {
                command: 'git tag',
                suppressOutput: (_m = options) === null || _m === void 0 ? void 0 : _m.suppressOutput,
                altCommand: ((_o = options) === null || _o === void 0 ? void 0 : _o.quiet) ? '' : undefined,
            }))[0].stdout;
        });
        /**
         * @param {string} workDir work dir
        ...
        this.push = (workDir, branch, context, options) => __awaiter(this, void 0, void 0, function* () {
            var _p, _q, _r;
            const args = [];
            if ((_p = options) === null || _p === void 0 ? void 0 : _p.withTag) {
                args.push('--tags');
            }
            if ((_q = options) === null || _q === void 0 ? void 0 : _q.force) {
                args.push('--force');
            }
            if ((_r = options) === null || _r === void 0 ? void 0 : _r.args) {
        ...
        this.getLastTag = (workDir) => __awaiter(this, void 0, void 0, function* () {
            ...
            return 'v' + (_t = (_s = tags.slice().sort(compareTag).reverse()[0]) === null || _s === void 0 ? void 0 : _s.replace(/^v/, ''), (_t !== null && _t !== void 0 ? _t : '0.0.0'));
        });
        /**
         * @param {string} workDir work dir
         * @return {string} tag
