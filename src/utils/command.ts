...
export const getDeleteTestTag = async(tagName: string, prefix, helper: GitHelper, context: Context): Promise<Array<string>> => (await helper.getTags(getParams(context).pushDir, {quiet: true}))
